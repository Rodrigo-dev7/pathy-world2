...
var toggle_variants_1 = require("@/components/ui/toggle-variants");
...
var ToggleGroup = React.forwardRef(function (_a, ref) {
    ...
    return React.createElement(ToggleGroupPrimitive.Root, __assign({ ref: ref, className: (0, utils_1.cn)("flex items-center justify-center gap-1", className) }, props), React.createElement(ToggleGroupContext.Provider, { value: { variant: variant, size: size } }, children));
});
...
var ToggleGroupItem = React.forwardRef(function (_a, ref) {
    ...
    var Element = ToggleGroupPrimitive.Item;
    return (<Element ref={ref} className={(0, utils_1.cn)((0, toggle_variants_1.toggleVariants)({
