...
var PaginationPrevious = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<PaginationLink aria-label="Go to previous page" className={(0, utils_1.cn)("gap-1 pl-2.5", className)} {...props}>
...
var PaginationNext = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<PaginationLink aria-label="Go to next page" className={(0, utils_1.cn)("gap-1 pr-2.5", className)} {...props}>
    <span>Next</span>
