...
var PanelGroup = ResizablePrimitive.PanelGroup;
var PanelResizeHandle = ResizablePrimitive.PanelResizeHandle;
var Panel = ResizablePrimitive.Panel;
var ResizablePanelGroup = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<PanelGroup className={(0, utils_1.cn)("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className)} {...props}/>);
};
